    ...
    <div class="w-full max-w-md">
        <div class="bg-neutral-0 rounded-2xl shadow-2xl overflow-hidden transform hover:shadow-3xl transition duration-300">
            ...
            <div class="p-10">
                ...
                <form method="POST" action="{{ route('customers.authenticate') }}">
                    @csrf
