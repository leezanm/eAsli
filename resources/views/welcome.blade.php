...
<section class="bg-gradient-to-br mt-5 from-neutral-100 to-neutral-50 py-16 relative overflow-hidden">
   ...
   <div class="max-w-7xl mt-5 mx-auto px-4 py-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            ...
            <a href="{{ route('shops.map') }}" class="inline-flex items-center px-4 py-2 rounded-lg border border-neutral-300 text-neutral-700 hover:bg-neutral-100 text-sm font-medium bg-white shadow-sm">
                ...
                <div class="p-6 relative z-10">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div>
                            ...
                            <p class="text-xl font-bold bg-gradient-to-r from-accent-500 to-accent-700 bg-clip-text text-transparent">RM {{ number_format($product->price, 2) }}</p>
                        </div>
                        <div class="flex flex-col items-end gap-2">
                            <a href="{{ route('products.show', $product->id) }}" class="bg-gradient-to-br from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold py-2 px-4 rounded-xl transition shadow-lg hover:shadow-2xl flex items-center justify-center text-xs">
