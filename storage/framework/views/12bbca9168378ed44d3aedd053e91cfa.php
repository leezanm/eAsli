                ...
                <div class="flex items-center gap-6">
                    ...
                    <div class="hidden lg:block relative group">
                        ...
                        <div class="absolute left-0 mt-1 w-56 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                            <a href="<?php echo e(route('products.index')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                ...
                <div>
                    ...
                    <ul class="text-sm space-y-3">
                        ...
                        <li><a href="<?php echo e(route('products.index')); ?>" class="text-neutral-300 hover:text-accent-400 transition flex items-center gap-2"><i class="fas fa-chevron-right text-accent-500"></i>Product Catalogue</a></li>
