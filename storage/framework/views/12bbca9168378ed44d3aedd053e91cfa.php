...
<head>
    ...
    <title><?php echo e(config('app.name', 'eAsli')); ?> - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="flex items-center justify-between h-20 gap-4">
                ...
                <div class="flex items-center gap-6">
                    <!-- Logo -->
                    <a href="<?php echo e(route('home')); ?>" class="text-3xl font-black flex items-center gap-1 whitespace-nowrap">
                    ...
                    <div class="hidden lg:block relative group">
                        ...
                        <div class="absolute left-0 mt-1 w-56 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                            <a href="<?php echo e(route('products.shop')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
                            ...
                            <a href="<?php echo e(route('shops.map')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition last:rounded-b-lg">
                ...
                <div class="hidden md:flex flex-1 max-w-3xl mx-4">
                    <form action="<?php echo e(route('products.shop')); ?>" method="GET" class="w-full">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <!-- Cart Icon -->
                    <a href="<?php echo e(route('cart.index')); ?>" class="text-neutral-800 hover:text-neutral-900 transition relative" title="Shopping Cart">
                        ...
                        <div class="relative group">
                            <button class="flex items-center gap-2 text-neutral-800 hover:text-neutral-900 transition text-sm font-medium">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-secondary-400 to-secondary-600 flex items-center justify-center text-white font-bold text-sm">
                                    <?php echo e(substr(auth('artisan')->user()->name, 0, 1)); ?>

                                </div>
                                <span class="hidden sm:inline"><?php echo e(auth('artisan')->user()->name); ?></span>
                            </button>
                            <div class="absolute right-0 mt-1 w-52 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                                <a href="<?php echo e(route('artisans.dashboard')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
                                    <i class="fas fa-chart-line mr-2"></i>Dashboard
                                </a>
                                <a href="<?php echo e(route('artisans.show', Auth::guard('artisan')->user()->id)); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition">
                                    <i class="fas fa-user-circle mr-2"></i>Profile
                                </a>
                                <a href="<?php echo e(route('artisans.change-password')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition">
                                    <i class="fas fa-key mr-2"></i>Change Password
                                </a>
                                <div class="border-t border-neutral-200"></div>
                                <form action="<?php echo e(route('artisans.logout')); ?>" method="POST" class="block">
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="relative group">
                            <button class="flex items-center gap-2 text-neutral-800 hover:text-neutral-900 transition text-sm font-medium">
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-secondary-500 to-secondary-700 flex items-center justify-center text-white font-bold text-sm">
                                    <?php echo e(substr(auth('web')->user()->name, 0, 1)); ?>

                                </div>
                                <span class="hidden sm:inline"><?php echo e(auth('web')->user()->name); ?></span>
                            </button>
                            <div class="absolute right-0 mt-1 w-52 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
                                    <i class="fas fa-cog mr-2"></i>Admin Panel
                                </a>
                                
                                <div class="border-t border-neutral-200"></div>
                                <form action="<?php echo e(route('admin.logout')); ?>" method="POST" class="block">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="w-full text-left px-4 py-3 text-red-600 hover:bg-red-50 transition last:rounded-b-lg">
                                        <i class="fas fa-sign-out-alt mr-2"></i>Logout
                                    </button>
                    ...
                    <?php if(auth()->guard('customer')->check()): ?>
                        <div class="relative group">
                            <button class="flex items-center gap-2 text-neutral-800 hover:text-neutral-900 transition text-sm font-medium">
                                ...
                                <span class="hidden sm:inline"><?php echo e(auth('customer')->user()->name); ?></span>
                            </button>
                            <div class="absolute right-0 mt-1 w-52 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                                <a href="<?php echo e(route('customers.show', auth('customer')->user())); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
                                    <i class="fas fa-receipt mr-2"></i>My Orders
                                </a>
                                <a href="<?php echo e(route('customers.history', auth('customer')->user()->id)); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition">
                                    <i class="fas fa-history mr-2"></i>Order History
                                </a>
                                <div class="border-t border-neutral-200"></div>
                                <form action="<?php echo e(route('customers.logout')); ?>" method="POST" class="block">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="w-full text-left px-4 py-3 text-red-600 hover:bg-red-50 transition last:rounded-b-lg">
                                        <i class="fas fa-sign-out-alt mr-2"></i>Logout
                                    </button>
                    ...
                    <?php if(auth('artisan')->guest() && auth('web')->guest() && auth('customer')->guest()): ?>
                        <div class="relative group">
                            <button class="flex items-center gap-2 text-neutral-800 hover:text-neutral-900 transition text-sm font-medium">
                            ...
                            <div class="absolute right-0 mt-1 w-56 bg-white border border-neutral-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                                <a href="<?php echo e(route('artisans.login')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition first:rounded-t-lg">
                                    <i class="fas fa-store mr-2"></i>Artisan Login
                                </a>
                                <a href="<?php echo e(route('customers.login')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition">
                                    <i class="fas fa-user mr-2"></i>Customer Login
                                </a>
                                <a href="<?php echo e(route('admin.login')); ?>" class="block px-4 py-3 text-neutral-800 hover:bg-neutral-50 transition last:rounded-b-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                ...
                <div>
                    ...
                    <ul class="text-sm space-y-3">
                        <li><a href="<?php echo e(route('home')); ?>" class="text-neutral-300 hover:text-accent-400 transition flex items-center gap-2"><i class="fas fa-chevron-right text-accent-500"></i>Home</a></li>
                        <li><a href="<?php echo e(route('shops.map')); ?>" class="text-neutral-300 hover:text-accent-400 transition flex items-center gap-2"><i class="fas fa-chevron-right text-accent-500"></i>Explore Shops</a></li>
                        <li><a href="<?php echo e(route('products.shop')); ?>" class="text-neutral-300 hover:text-accent-400 transition flex items-center gap-2"><i class="fas fa-chevron-right text-accent-500"></i>Product Catalogue</a></li>
                        <li><a href="<?php echo e(route('artisans.login')); ?>" class="text-neutral-300 hover:text-accent-400 transition flex items-center gap-2"><i class="fas fa-chevron-right text-accent-500"></i>Artisan Login</a></li>
                    </ul>
                </div>
                <div>
...
<?php /**PATH /Users/leezanm/eAsli-app/resources/views/layouts/app.blade.php ENDPATH**/ ?>