...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col gap-3">
                    <a href="<?php echo e(route('artisans.login')); ?>" class="text-center bg-primary-50 hover:bg-primary-100 text-primary-700 font-semibold py-3 rounded-lg transition">
                        <i class="fas fa-user-circle mr-2"></i>Login as Artisan
                    </a>
                    <a href="<?php echo e(route('home')); ?>" class="text-center text-primary-600 hover:text-primary-800 font-semibold py-2 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leezanm/eAsli-app/resources/views/admin/login.blade.php ENDPATH**/ ?>