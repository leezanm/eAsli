    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="mb-10">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-neutral-0 rounded-2xl shadow-lg p-8 border-l-8 border-primary-600">
                <div>
                    ...
                    <p class="text-lg text-neutral-700"><i class="fas fa-user-circle text-primary-600 mr-2"></i>Welcome, <span class="font-bold text-primary-700"><?php echo e(auth('web')->user()->name); ?></span></p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div class="bg-neutral-0 rounded-xl shadow-md hover:shadow-xl transition p-8 border-l-4 border-primary-600 group">
                ...
                <p class="text-4xl font-bold text-primary-800"><?php echo e(\App\Models\Artisan::count()); ?></p>
            ...
            <div class="bg-neutral-0 rounded-xl shadow-md hover:shadow-xl transition p-8 border-l-4 border-secondary-600 group">
                ...
                <p class="text-4xl font-bold text-secondary-800"><?php echo e(\App\Models\Shop::count()); ?></p>
            ...
            <div class="bg-neutral-0 rounded-xl shadow-md hover:shadow-xl transition p-8 border-l-4 border-accent-500 group">
                ...
                <p class="text-4xl font-bold text-accent-800"><?php echo e(\App\Models\Product::count()); ?></p>
            ...
            <div class="bg-neutral-0 rounded-xl shadow-md hover:shadow-xl transition p-8 border-l-4 border-primary-500 group">
                ...
                <p class="text-4xl font-bold text-secondary-900"><?php echo e(\App\Models\Sale::count()); ?></p>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Manage Artisans -->
                <a href="<?php echo e(route('artisans.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-primary-600 group hover:scale-105 transform duration-300">
                ...
                <!-- Manage Shops -->
                <a href="<?php echo e(route('shops.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-secondary-600 group hover:scale-105 transform duration-300">
                    <div class="flex items-center gap-4 mb-4">
                ...
                <!-- Manage Products -->
                <a href="<?php echo e(route('products.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-primary-500 group hover:scale-105 transform duration-300">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="bg-primary-100 p-4 rounded-lg group-hover:bg-primary-200 transition">
                ...
                <!-- Manage Customers -->
                <a href="<?php echo e(route('customers.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-secondary-500 group hover:scale-105 transform duration-300">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="bg-secondary-100 p-4 rounded-lg group-hover:bg-secondary-200 transition">
                ...
                <!-- Manage Sales -->
                <a href="<?php echo e(route('sales.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-primary-600 group hover:scale-105 transform duration-300">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="bg-primary-100 p-4 rounded-lg group-hover:bg-primary-200 transition">
                            <i class="fas fa-receipt text-primary-700 text-2xl"></i>
                        </div>
                ...
                <!-- View Reports -->
                <a href="<?php echo e(route('reports.index')); ?>" class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-8 border-t-4 border-secondary-600 group hover:scale-105 transform duration-300">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="bg-secondary-100 p-4 rounded-lg group-hover:bg-secondary-200 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leezanm/eAsli-app/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>