                    ...
                    <form method="POST" action="<?php echo e(route('reports.sales')); ?>" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="date" name="start_date" required value="<?php echo e(date('Y-m-01')); ?>" class="w-full px-3 py-2 rounded-lg border border-neutral-300 text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-neutral-700 uppercase mb-2">End Date</label>
                                <input type="date" name="end_date" required value="<?php echo e(date('Y-m-d')); ?>" class="w-full px-3 py-2 rounded-lg border border-neutral-300 text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition">
                            </div>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('reports.performance')); ?>" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="block text-xs font-semibold text-neutral-700 uppercase mb-2">Start Date</label>
                                <input type="date" name="start_date" required value="<?php echo e(date('Y-m-01')); ?>" class="w-full px-3 py-2 rounded-lg border border-neutral-300 text-sm focus:outline-none focus:border-secondary-500 focus:ring-2 focus:ring-secondary-200 transition">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-neutral-700 uppercase mb-2">End Date</label>
                                <input type="date" name="end_date" required value="<?php echo e(date('Y-m-d')); ?>" class="w-full px-3 py-2 rounded-lg border border-neutral-300 text-sm focus:outline-none focus:border-secondary-500 focus:ring-2 focus:ring-secondary-200 transition">
                            </div>
                        </div>
                        ...
                        <tbody class="divide-y divide-neutral-100">
                            ...
                            <tr class="hover:bg-neutral-50/50 transition">
                                <td class="px-6 py-4 align-top text-neutral-900 font-semibold flex items-center gap-2">
                                    <?php if($report->report_type == 'sales'): ?>
                                    <i class="fas fa-receipt text-primary-600"></i> Sales Report
                                    <?php elseif($report->report_type == 'stock'): ?>
                                ...
                                <td class="px-6 py-4 align-top">
                                    <?php if(($report->status ?? null) == 'generated'): ?>
                                ...
                                <td class="px-6 py-4 align-top text-right">
                                    <a href="<?php echo route('reports.show', $report); ?>" class="text-primary-700 hover:text-primary-900">                <i class="fas fa-eye text-md text-neutral-300 mb-4"></i>
View</a>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
