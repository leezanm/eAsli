    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12">
            ...
            <div class="flex flex-col gap-3">
                <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-neutral-300 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition">
                    ...
                    <div class="bg-gradient-to-br from-neutral-0 to-neutral-50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group hover:translate-y-[-12px] border-t-4 border-primary-400 relative hover:border-primary-500">
                        ...
                        <div class="p-6 relative z-10">
                            ...
                            <?php if($product->description): ?>
                                <p class="text-sm text-neutral-600 line-clamp-2 mb-3"><?php echo e($product->description); ?></p>
                            <?php endif; ?>
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold bg-gradient-to-r from-accent-500 to-accent-700 bg-clip-text text-transparent">RM <?php echo e(number_format($product->price, 2)); ?></p>
                                </div>
                                ...
                                <div class="flex items-center gap-2 pt-2">
                                    <a href="<?php echo e(route('products.show', $product)); ?>" class="flex-1 bg-gradient-to-br from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-bold py-2 px-4 rounded-xl transition shadow-lg hover:shadow-2xl flex items-center justify-center text-sm gap-1">
                                        <i class="fas fa-eye"></i>
                                        <span>View</span>
                                    </a>
                                    <?php if(!auth('artisan')->check() && !auth('web')->check()): ?>
                                        <form method="POST" action="<?php echo e(route('cart.add', $product)); ?>" class="flex-1">
                                            <?php echo csrf_field(); ?>
...
function filterProducts() {
    ...
    window.location.href = `<?php echo e(route('products.shop')); ?>?search=${encodeURIComponent(search)}&category=${encodeURIComponent(category)}`;
}
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leezanm/eAsli-app/resources/views/products/shop.blade.php ENDPATH**/ ?>