        ...
        <form method="POST" action="<?php echo e(route('customers.update', $customer)); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-neutral-300 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?> text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-neutral-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="tel" class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-neutral-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition"
                    id="phone" name="phone" value="<?php echo e(old('phone', $customer->phone)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea class="w-full px-4 py-3 rounded-lg border <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php else: ?> border-neutral-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> text-sm focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200 transition" rows="3"
                    id="address" name="address"><?php echo e(old('address', $customer->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="<?php echo e(route('customers.show', $customer)); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-neutral-100 hover:bg-neutral-200 text-neutral-800 text-sm font-semibold border border-neutral-300 transition">
    ...
    <!-- Back Link -->
    <div class="mt-6">
        <a href="<?php echo e(route('customers.index')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-primary-700 hover:text-primary-800 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leezanm/eAsli-app/resources/views/customers/edit.blade.php ENDPATH**/ ?>