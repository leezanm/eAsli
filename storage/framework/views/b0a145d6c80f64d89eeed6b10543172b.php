        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8 md:p-10">
                ...
                <form method="POST" action="<?php echo e(route('customers.store')); ?>">
                    ...
                    <input type="hidden" name="redirect_to" value="<?php echo e(request()->has('redirect_to') ? request('redirect_to') : request()->header('referer', route('home'))); ?>">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                   class="w-full px-5 py-3 border-2 border-neutral-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition text-neutral-900 font-medium <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="tel" name="phone" id="phone"
                               class="w-full px-5 py-3 border-2 border-neutral-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition text-neutral-900 font-medium <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="address" id="address" rows="3"
                                  class="w-full px-5 py-3 border-2 border-neutral-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition text-neutral-900 font-medium <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('home')); ?>" class="flex-1 bg-neutral-100 hover:bg-neutral-200 text-neutral-800 font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition uppercase tracking-wide flex items-center justify-center gap-2">
                    ...
                    <div class="text-center mt-6 pt-6 border-t border-neutral-200">
                        <p class="text-neutral-700 text-sm">Already have an account?
                            <a href="<?php echo e(route('customers.login')); ?>" class="text-primary-700 hover:text-primary-800 font-bold">Login here</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leezanm/eAsli-app/resources/views/customers/create.blade.php ENDPATH**/ ?>