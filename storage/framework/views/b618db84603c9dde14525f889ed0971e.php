                ...
                <tbody class="bg-white divide-y divide-neutral-100">
                    <?php $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-secondary-50/70 transition">
                            ...
                            <td class="px-6 py-3 whitespace-nowrap text-neutral-800">RM <?php echo e(number_format($customer->sales_sum_total_price ?? 0, 2)); ?></td>
                            <td class="px-6 py-3 whitespace-nowrap">
                                <a href="<?php echo e(route('customers.show', $customer)); ?>" class="inline-flex items-center gap-2 text-xs font-semibold text-primary-700 hover:text-primary-800">
